...
2. Compare with our adapted skills:
   ...
   - `plan-creation` ← based on Superpowers `writing-plans`
   - `verification-review` ← based on Superpowers `verification-before-completion` + `requesting-code-review`
   - `finishing-branch` ← based on Superpowers `finishing-a-development-branch`
