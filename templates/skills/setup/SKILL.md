...
Set project-specific values in each agent's file ownership section:
...
- `dev-database.md`: Set file ownership paths based on detected migration/schema directory
- `dev-test.md`: Set file ownership paths based on detected E2E/integration test directory
- `dev-devops.md`: Set file ownership paths based on detected Docker/CI/infra files
